<div class="p-3 ml-12 md:ml-3 w-full">
    ...
    <div class="bg-white rounded  shadow-md">
        ...
        <!-- tambah stock modal -->
        <div id="tambahStockModal" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded shadow">
                    ...
                    <!-- Modal body -->
                    <form action="<?= base_url('Stock/tambahStock'); ?>" method="post" enctype="multipart/form-data"
                        class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <?php
                            ...
                            ?>
                            <input name="tanggal" id="tanggal" type="hidden"
                                value="<?= date('Y-m-d H:i:s', $timestamp_sekarang) ?>">
                        ...
                        <div class="text-end">
                            <button data-modal-hide="tambahStockModal" type="button"
                                class="text-end bg-white shadow-md hover:bg-gray-100 border text-gray-500 font-medium rounded text-sm px-3 py-2">
                                Batal
                            </button>
                            <button type="submit"
